...
@section('page-title', 'List Tag - Admin Page')
@section('content')
...
<div class="card">
    <div class="card-header elegant-color align-middle ">
        ...
        <a href="/admin/tag/create"><button type="button" class="btn btn-yellow waves-effect waves-light float-right ml-auto">Upload new</button></a>
    </div>
    <div class="card-body">
